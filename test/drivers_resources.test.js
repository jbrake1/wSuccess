...
describe('Drivers and Resources CRUD Tests', function() {
  let driver;
  ...
  it('should create a new driver/resource', async function() {
    // Test will be implemented
  });

  it('should delete a driver/resource', async function() {
    // Test will be implemented  
  });
});
